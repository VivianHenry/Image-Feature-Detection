...
image = imread(url4);
image_int = image(:, :);
image_original = medfilt2(image_int, [3, 3]);
...
subplot(2, 2, 1);
imshow(image_int); title("Original Image");

subplot(2, 2, 2);
imshow(image_original); title("Applying median filter");
